...
$lines = @(
    ...
    "",
    "This page is generated from ``models/establishment-details-shacl.ttl`` during the site build. Do not edit this file directly.",
    "",
    ...
    "| Not applicable | The field must not be present for this type |",
    ""
)

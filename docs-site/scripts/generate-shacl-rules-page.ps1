...
$lines = @(
    ...
    "",
    "This page documents current GIAS field applicability rules by establishment type. It is generated from ``models/establishment-details-shacl.ttl`` during the site build. Do not edit this file directly.",
    "",
